defmodule AttendancePortalWeb.Router do
  use AttendancePortalWeb, :router
  ...
  scope "/", AttendancePortalWeb do
    ...
    post "/api/v1/login", PageController, :login
    resources(
  ...
  # scope "/api", AttendancePortalWeb do
  #   pipe_through :api
  # end
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      ...
      live_dashboard "/dashboard", metrics: AttendancePortalWeb.Telemetry
    end
  end
